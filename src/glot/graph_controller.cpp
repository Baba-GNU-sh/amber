...
void GraphController::draw()
{
    ...
    auto marker_styles = marker_style();
    if (m_markers.first.visible)
    {
        m_graph.draw_marker("A",
                            m_markers.first.position,
                            marker_styles.first,
    ...
    {
        m_graph.draw_marker("B",
                            m_markers.second.position,
                            marker_styles.second,
